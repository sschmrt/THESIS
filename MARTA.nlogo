...
to move
  ...
  if cycle? and time > 500[
      set-current-plot "Fundamental diagram" plotxy (Nb-peds / world-width / world-height) (Nb-peds / world-width / world-height * mean-speed / ticks)
      set-current-plot "Speed stddev" plotxy (Nb-peds / world-width / world-height) (stddev-speed / ticks)
      ask peds [die] set Nb-peds Nb-peds + 20
      set time 0 set mean-speed 0 set stddev-speed 0  set flow-cum 0
      set-current-plot "Speed" clear-plot set-current-plot "Mean flow" clear-plot reset-ticks
